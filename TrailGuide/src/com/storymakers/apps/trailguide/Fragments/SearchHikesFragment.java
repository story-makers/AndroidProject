...
public class SearchHikesFragment extends HikesListFragment {
	private SearchHikesFragment fragmentHomeSearchHikesList;

	public static SearchHikesFragment newInstance() {
		SearchHikesFragment fragmentDemo = new SearchHikesFragment();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		fragmentHomeSearchHikesList = this;
	...
	public void populateTimeLine(long max_id) {
		...
		segments.add(seg2);
		segments.add(seg3);
		fragmentHomeSearchHikesList.addAll(segments);
	}
}
